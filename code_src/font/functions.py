...
def render_letter(letter: str, textcolor="white") -> pygame.Surface:
...
def render_line(phrase: str, textcolor="white", bg_color="black"):
    surface = pygame.Surface((WIDTHCHAR*len(phrase), FONTSIZE))
    surface.fill(bg_color)
    for x, letter in enumerate(phrase):
        letter_surface = render_letter(letter, textcolor=textcolor)
